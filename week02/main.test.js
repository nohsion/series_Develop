...
const main = require('./main') // .js 생략 가능
...
test(
    'test invalid email',
    function () {
        expect(testFunction('test.com')).toBe(false)
    }
)

test(
    'test invalid email(Num)',
    function () {
        expect(testFunction(10)).toBe(false)
    }
)
